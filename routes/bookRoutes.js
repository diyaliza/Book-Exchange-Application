...
router.put('/update/:id', authenticate, authorize, booksController.updateBookAndReturn);
router.delete('/delete/:id',authenticate,authorize, booksController.deleteBookById);
